...
echo_and_run cd "/home/irman/Documents/Tubes/Prog/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/irman/Documents/Tubes/Prog/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/irman/Documents/Tubes/Prog/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
