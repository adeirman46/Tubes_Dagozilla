...
(cl:defmethod cl:initialize-instance :after ((m <HardwareCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HardwareCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name control-msg:<HardwareCommand> is deprecated: use control-msg:HardwareCommand instead.")))
